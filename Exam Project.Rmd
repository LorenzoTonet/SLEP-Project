...
```{r roc curve, warning=FALSE}
library(timeROC)
ROC.thick<-timeROC(T=data.cl$time,delta=data.cl$pat.karno,marker=melanom$thick,cause=1, times=c(1800,2000,2200),iid=TRUE)
```
=======
>>>>>>> 1f3963206021c019608e9f9f6f7c939607ae3b0a
